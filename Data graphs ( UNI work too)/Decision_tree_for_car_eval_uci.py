# Decision tree for UCI Car Evaluation
import pandas as pd
...
y = car.data.targets["class"].copy()

# 2) Define ordered categories for ordinal encoding
cat_orders = {
...
categories = [cat_orders[col] for col in X.columns]
...
# 4) Pipeline: encode -> decision tree
pipe = Pipeline([
